...
export const dropItemsReducer = createSlice({
  name: 'dropItems',
  initialState: {
    value: [
      {
  ...
  reducers: {
    setAllDropItems: (state, action) => {
      state.value = action.payload;
    },
  },
});

export const { setAllDropItems } = dropItemsReducer.actions;
export default dropItemsReducer.reducer;
